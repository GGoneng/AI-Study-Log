...
def min_preprocessing_text(text):
    ...
    STOPWORDS_PATH = r'C:\Users\KDP-2\OneDrive\바탕 화면\Python\EX_WEB\WEB\cgi-bin\stopwords-ko.txt'
...
class SentenceClassifier(nn.Module):
    ...
    with open(r'C:\Users\KDP-2\OneDrive\바탕 화면\Python\EX_WEB\WEB\cgi-bin\vocab_min.pkl', 'rb') as f:
        vocab = pickle.load(f)

    PAD_TOKEN, OOV_TOKEN = 'pad', 'oov'

    word2vec = Word2Vec.load(r'C:\Users\KDP-2\OneDrive\바탕 화면\Python\EX_WEB\WEB\cgi-bin\word2vec.model')
    ...
    def __init__(self,
                 ...
                 n_layers = n_layers,
                 dropout = 0.5,
                 # 양방향은 빈 칸에 들어갈 단어를 고르는 등, 앞 문장과 뒷 문장이 둘 다 중요할 때 사용
                 bidirectional  = True,
                 model_type = 'lstm',
